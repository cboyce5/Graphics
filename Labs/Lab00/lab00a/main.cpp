...
//Draw my triangle function for lab00a
...
//Draw my triforce fucntion for lab00a

void drawMyTriforce() {
	
	//triangle 1 in second triforce
	glPushMatrix();
	glTranslatef( -25, -25, 0 );
	drawMyTriangle();
	glPopMatrix();
	
	//triangle 2 in second triforce
	glPushMatrix();
	glTranslatef( 75, -25, 0 );
	drawMyTriangle();
	glPopMatrix();
	
	//triangle 3 in second triforce
	glPushMatrix();
...
void renderScene() {
	...
	//Triangle 1 in the first triforce
	glBegin( GL_TRIANGLES );
	glVertex2f( 100, 100 );
	glVertex2f( 200, 100 );
	glVertex2f( 150, 180 );
	
	//Triangle 2 in the first triforce
	glVertex2f( 200, 100 );
	glVertex2f( 300, 100 );
	glVertex2f( 250, 180 );
	
	//Triangle 3 in the first triforce
	glVertex2f( 150, 180 );
	glVertex2f( 250, 180 );
	glVertex2f( 200, 260 );
