...
void generateEnvironmentDL() {
        ...
        for(int j = 0; j < gridY-1; j++) {
            ...
            if( i % 2 && j % 2 && getRand() < 0.4f ) {
                glPushMatrix(); {
					...
					float val[4] = {getRand(),getRand(),getRand(),1.0};
    ...
    // DRAW OUR GRID
    float mat[4] = {0.07568,0.61424,0.07568,1.0};
    ...
    glPushMatrix(); {
        ...
        float val[4] = {0.25,0.20727,0.20725,1.0};
...
void initializeOpenGL( int argc, char *argv[] ) {
    ...
    float diffuseCol[4] = { 0.25, 0.5, 0.3, 1.0 };           // TODO #06: Change the colors!
