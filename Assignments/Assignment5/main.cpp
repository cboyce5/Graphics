...
int main(int argc, char **argv) {
	...
	//make sure all arguments are passed in correctly
	...
	if (argc != 4) {
		fprintf(stdout, "Please enter an object file, and a vertex and fragemt shader as arguments.\n");
		exit(0);
	}
	else {
		setupShaders();
		object = new Object( argv[1] );
	}
