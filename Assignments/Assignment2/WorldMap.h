#ifndef _441_WORLDMAP_H_
#define _441_WORLDMAP_H_

// here's a fun fact....glut internally includes gl.h and glu.h
...
const GLint MAP_WIDTH = 8, MAP_HEIGHT = 8;				// sets the width and height of our 2D map array
GLint mapHandles[ MAP_WIDTH ][ MAP_HEIGHT ];			// a 2D storing the texture handles of our world map backgrounds
GLint currMapLocationX = 4, currMapLocationY = 4;		// our current location within the map
